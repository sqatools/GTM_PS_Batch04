import time
import pytest
from modules.goibigo_website.end_end_one_way_flight import GoibigoOneWayFlight
...
class TestGoibigoOneWayFlight:
    ...
    def test_goibigo_register_page(self):
        ...
        self.gof.dep_time_select()
        self.gof.click_stops_details()
        self.gof.price_range_drag()
        #self.gof.pref_airline()
        #self.gof.view_fair()
